...
class LimeTabularExplainerOvr(LimeTabularExplainer):
    ...
    def check_stability(self,
        ...
        #ADDED: list to gater all explanations
        exps =[]
        ...
        for i in range(n_calls):
            ...
            #ADDED: gather all explanations generated
            exps.append(exp)
        ...
        #ADDED: in addition to csi, vsi, len(confidence_intervals) return exps
        return csi, vsi, len(confidence_intervals), exps
