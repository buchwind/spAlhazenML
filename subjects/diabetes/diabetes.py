...
saved_model = load(Path(__file__).parent / "diabetes.joblib")

class DiabetesBug(bug_class.Bug):
	"""
	...
	def sample_files(self):
		...
		"""
		yield Path(__file__).parent / "samples" / "diabetes.1.expr"
		yield Path(__file__).parent / "samples" / "diabetes.2.expr"
