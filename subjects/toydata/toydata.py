...
saved_model = load(Path(__file__).parent / "toy.joblib")

class ToyDataBug(bug_class.Bug):
	"""
	...
	def sample_files(self):
		...
		"""
		yield Path(__file__).parent / "samples" / "toydata.1.expr"
		yield Path(__file__).parent / "samples" / "toydata.2.expr"
